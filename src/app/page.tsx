      ...
      <section className="flex flex-col items-center px-6 py-24">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 w-full max-w-4xl justify-center">
          ...
          <div className="flex flex-col items-center flex-shrink-0 w-full lg:w-auto">
            ...
            {[
              { time: "13h45", label: "Rendez-vous à la mairie", href: "#mairie" },
              { time: "Après la mairie", label: "Départ vers le domaine", href: "#domaine" },
              { time: "15h – 16h", label: "Arrivée au domaine", href: "#domaine" },
              { time: "16h", label: "Début de la cérémonie", href: "#domaine" },
            ].map(({ time, label, href }) => (
      ...
      <div className="flex flex-col gap-0">
        ...
        <section id="mairie" className="flex flex-col lg:flex-row-reverse items-center lg:items-start gap-10 px-6 py-16 sm:py-20 max-w-4xl mx-auto w-full">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left flex-1 pt-2 w-full">
            ...
            <p className="text-stone-600 text-base sm:text-lg leading-loose mb-4">
              La cérémonie à la mairie débutera à <strong className="text-stone-900 font-semibold">14h</strong>, les places intérieures seront limitées mais l&apos;ambiance sera garantie à la sortie des mariés&nbsp;!
            </p>
            <p className="text-stone-400 text-base sm:text-lg leading-relaxed border-l-2 border-stone-200 pl-4 text-left mb-5">
       
              Ensuite, les mariés iront faire une rapide séance photo au belvédère en petit comité. Ils vous rejoindront ensuite au domaine.
            </p>
            <div className="flex items-start gap-3 rounded-xl bg-stone-50 border border-stone-200 px-4 py-3 text-left">
              <div>
                <p className="text-xs uppercase tracking-widest text-stone-400 mb-1">Parking (souterrain, payant)</p>
                <p className="text-stone-600 text-sm leading-relaxed">Parking Indigo — Square Aristide Briand, 74200 Thonon-les-Bains</p>
              </div>
            </div>
          </div>
        ...
        <section id="domaine" className="flex flex-col items-center px-6 py-20 text-center w-full">
          ...
          <div className="grid gap-4 text-left text-base text-stone-500 sm:grid-cols-2 max-w-xl w-full">
            <div className="rounded-2xl bg-white p-5 shadow border border-stone-200 flex gap-4 items-start" style={{ backgroundColor: "white" }}>
        ...
        <section id="camping" className="flex flex-col lg:flex-row items-center lg:items-start gap-10 px-6 py-16 sm:py-20 max-w-4xl mx-auto w-full">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left flex-1 pt-2 w-full">
            ...
            <div className="w-12 h-px bg-stone-300 mb-6" />
            <p className="text-stone-600 text-base sm:text-lg leading-loose mb-4">
              Un champ du domaine sera à disposition pour ceux qui souhaitent camper sur place.
            </p>
            <p className="text-stone-400 sm:text-lg leading-relaxed border-l-2 border-stone-200 pl-4 text-left">
              Vous pouvez venir avec votre tente et l&apos;installer dès votre arrivée, ou pendant la journée.
            </p>
          </div>
        ...
        {/* ── ENFANTS ── */}
        <section id="enfants" className="flex flex-col lg:flex-row items-center lg:items-start gap-10 px-6 py-16 sm:py-20 max-w-4xl mx-auto w-full">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left flex-1 pt-2 w-full">
            ...
            <div className="flex items-start gap-3 bg-white rounded-2xl border border-stone-100 shadow-sm px-5 py-4 text-left">
              <Baby className="size-5 text-stone-400 mt-0.5 shrink-0" />
              <p className="text-stone-500 text-base leading-relaxed">Une salle sera dédiée aux enfants, principalement pour le repas.</p>
            </div>
          </div>
